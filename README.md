Este proyecto consiste en un backend desarrollado con Spring Boot, encargado de exponer una API REST para administrar las acciones del concurso Spelling Bee. Entre las funcionalidades se incluyen:
