...
public interface RoundStudentService {
    List<RoundStudentDTO> listRoundsByNumberRoundAndGrades(Integer numberRound, Integer idGrade);
    RoundStudentDTO updateRound(Integer idRound, RoundStudentDTO roundStudentDTO);
